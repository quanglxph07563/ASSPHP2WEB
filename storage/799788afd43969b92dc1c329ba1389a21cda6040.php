            ...
            <tbody>
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href=" <?php echo e(BASE_URL . 'edit-brand/' .$value->id); ?> " class="btn btn-primary btn-sm ">Sửa</a>&nbsp;
                            <a href="<?php echo e(BASE_URL . 'remove-edit-brand/' .$value->id); ?>" class="btn btn-danger btn-sm btn-remove">Xóa</a>
                        </td>
                    </tr>
