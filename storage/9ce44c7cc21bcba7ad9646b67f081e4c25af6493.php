...
<section class="content">
    <div class="container-fluid">
        ...
        <form id="add-product-form" action="<?php echo e(BASE_URL . 'brand/save-edit-brand'); ?>" method="post" enctype="multipart/form-data">
            <h3>Thêm mới sản phẩm</h3>
            <div class="row col-md-6 mx-auto">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Tên nhãn hiệu<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" value="<?php echo e($databrand->brand_name); ?>" name="brand_name">
                    </div>

                    <div class="form-group">
                        <label for="">Quốc gia</label>
                        <input type="text" class="form-control" value="<?php echo e($databrand->country); ?>" name="country">
                    </div>
                </div>
                <input type="text" name="id" hidden value="<?php echo e($databrand->id); ?> ">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-8 offset-2">
                            <img id="preview-img" src="<?php echo e(BASE_URL . $databrand->logo); ?> " class="img-fluid">
                        </div>
                    </div>
                    <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\quanglxph07563-PHP2-Ass\views/brands/edit_brade.blade.php ENDPATH**/ ?>